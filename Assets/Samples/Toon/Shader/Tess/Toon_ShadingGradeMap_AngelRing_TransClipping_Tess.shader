...
Shader "UnityChanToonShader/Tessellation/AngelRing/Toon_ShadingGradeMap_TransClipping" {
    Properties {
        ...
        [MaterialToggle] _Is_LightColor_2ndShade ("Is_LightColor_2nd Shade", Float ) = 1
